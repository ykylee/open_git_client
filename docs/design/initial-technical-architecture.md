...
- 문서 버전: v0.2
- 작성일: 2026-03-11
- 기준 문서: `docs/requirements/CRS.md` v0.5, `docs/requirements/SRS.md` v0.6
...
- Release 1 범위에서는 로컬 Git 작업과 시각적 이력 탐색 기능에 집중한다.
...
## 변경 이력
- 2026-03-11 v0.2: SRS v0.6 기준으로 업데이트하고 Release 1 범위를 반영
